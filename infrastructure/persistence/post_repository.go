...
func (r *PostRepository) FindOneBySlug(postSlug string) (*entities.Post, error) {
	query := `
...
func (r *PostRepository) FindOneById(ctx context.Context, postSlug *string) *entities.Post {
	query := `
...
func (r *PostRepository) Create(req request.CreatePostRequest) (*entities.Post, error) {
	query := `
	...
	slug := services.GenerateSlug(req.Title)
...
func (r *PostRepository) Update(req request.UpdatePostRequest, postSlug string) (*entities.Post, error) {
	query := `
		update posts
	...
	if slug == nil {
		newSlug := services.GenerateSlug(req.Title)
		slug = &newSlug
	}
